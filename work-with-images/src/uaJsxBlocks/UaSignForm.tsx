...
const UaSignForm = ({setAuthorization}:{setAuthorization:any}) => {
    ...
    return(
        ...
        <div className="singFormFon form">
                <div className="signFormButtonBlock">
                    ...
                    <h3 className="signFormHeader">{sign ? "Зареєструватись" : "Авторизуватись"} </h3>
                    <hr/>
                    <p className="signFormDescription">Логін</p>
                    <input
                    ...
                    <p className="signFormDescription">Пароль</p>
                    <input
                        className="signFormInput"
                        value={pass}
                        type="password"
                ...
                <div className="errorLoginMessage">
                    {!sign && wrongLogin &&
                        <p className="errorLoginText">*Ви ввели неправильно логін, або пароль</p>
                    }
                </div>
                    <div className="signFormButtonBlock">
                        <button className="signFormButton" onClick={onSubmit}>
                            {sign ? "Зареєструватись" : "Авторизуватись"}
                        </button>
                    </div>
                </div>
        </>
