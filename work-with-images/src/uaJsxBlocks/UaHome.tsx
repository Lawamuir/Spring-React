    ...
    return (
        <>
            <div className="mainContent">
                <h3>Поточний спосіб побудови карти: {user && user?.mode != undefined && waysToBuildMap?.[user?.mode]}</h3>
                <button className="chooseFile" onClick={chooseFile}>
                    Виберіть зображення з розширенням bmp
                </button>
                <input
                    style={{display:"none"}}
                    ref={fileInputRef}
                    ...
                    <>
                        ...
                        <div className="waysButtonBlock">
                            ...
                            <button  className="waysButton" onClick={wayOfBuildingMap}>
                                Вибрати інший спосіб побудови бітової карти
                            </button>
                        </div>

                        {
                            ...
                            <div className="chooseWayForm form">
                                ...
                                <h3 className="signFormHeader">Оберіть спосіб</h3>
                                <hr/>
                                {
                                    ...
                                    <>
                                        <div className="imageSingleResultItem">
                                            ...
                                            <div className="bottomBlockOfHomeImage">
                                                <p className="homeResultText">Результат</p>
                                        ...
                                        <div className="imageButtonsMenu">
                                            <button className="imageButtonMenu" onClick={onOpenTextArea}>Додати приховане повідомлення</button>
                                            <button className="imageButtonMenu" onClick={extractSecretMessage}>Вилучити приховане повідомлення</button>
                                            {
                                                openTextArea &&
                                                <div>
                                                    <p className="addMessageHeader">Напишіть секретне повідомлення до цього зображення</p>
                                                    <textarea className="secretMessage" onChange={onTextAreaChange} id="message" cols={30} rows={4}/>
                                                    <button className="imageButtonMenu" onClick={sendHideMessage}>Надіслати</button>
